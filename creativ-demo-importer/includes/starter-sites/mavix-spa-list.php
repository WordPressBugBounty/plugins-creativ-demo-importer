...
$starter_sites = array(
    'spa' => array(
        'title'          => __( 'Spa', 'creativ-demo-importer' ), 
        'is_pro'         => false,
        'type'           => 'elementor',
        ...
        'template_url'   => array(
            'content' => CREATIV_DEMO_IMPORTER_URL. 'includes/starter-sites/json/mavix-spa/content.json',
            'options' => CREATIV_DEMO_IMPORTER_URL. 'includes/starter-sites/json/mavix-spa/options.json',
            'widgets' => CREATIV_DEMO_IMPORTER_URL. 'includes/starter-sites/json/mavix-spa/widgets.json',
        ),
        'screenshot_url' => CREATIV_DEMO_IMPORTER_URL.'assets/img/mavix-spa.jpg',
        'demo_url'       => 'https://creativthemes.com/theme-demo/mavix-spa/',
    ),
    'spa-pro' => array(
