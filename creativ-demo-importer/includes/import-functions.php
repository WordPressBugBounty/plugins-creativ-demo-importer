...
function creativ_demo_importer_starter_sites($starter_sites){
    ...
    elseif(get_stylesheet() == 'mavix-charity'){
        require plugin_dir_path(__FILE__) . 'starter-sites/mavix-charity-list.php';
    }
    elseif(get_stylesheet() == 'creativ-business-fse'){
        require plugin_dir_path(__FILE__) . 'starter-sites/creativ-business-fse-list.php';
    }
    ...
    elseif(get_stylesheet() == 'mavix-accounting'){
        require plugin_dir_path(__FILE__) . 'starter-sites/mavix-accounting-list.php';
    }
