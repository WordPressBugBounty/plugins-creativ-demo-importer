...
$starter_sites = array(
    'courier' => array(
        'title'          => __( 'Courier', 'creativ-demo-importer' ), 
        'is_pro'         => false,
        'type'           => 'elementor',
        ...
        'template_url'   => array(
            'content' => CREATIV_DEMO_IMPORTER_URL. 'includes/starter-sites/json/mavix-courier/content.json',
            'options' => CREATIV_DEMO_IMPORTER_URL. 'includes/starter-sites/json/mavix-courier/options.json',
            'widgets' => CREATIV_DEMO_IMPORTER_URL. 'includes/starter-sites/json/mavix-courier/widgets.json',
        ),
        'screenshot_url' => CREATIV_DEMO_IMPORTER_URL.'assets/img/mavix-courier.jpg',
        'demo_url'       => 'https://creativthemes.com/theme-demo/mavix-courier/',
    ),
    'courier-pro' => array(
        'title'          => __( 'Courier Pro', 'creativ-demo-importer' ), 
        'is_pro'         => true,
        'type'           => 'elementor',
        'author'         => __( 'Creativ Themes', 'creativ-demo-importer' ),
        'keywords'       => array( 'mavix', 'business' ),
        'categories'     => array( 'business' ),
        'template_url'   => array(
            'content' => CREATIV_DEMO_IMPORTER_URL. 'includes/starter-sites/json/mavix-courier-pro/content.json',
            'options' => CREATIV_DEMO_IMPORTER_URL. 'includes/starter-sites/json/mavix-courier-pro/options.json',
            'widgets' => CREATIV_DEMO_IMPORTER_URL. 'includes/starter-sites/json/mavix-courier-pro/widgets.json',
        ),
        'screenshot_url' => CREATIV_DEMO_IMPORTER_URL.'assets/img/mavix-courier-pro.jpg',
        'demo_url'       => 'https://creativthemes.com/theme-demo/mavix-courier-pro/',
        'pro_url'        => 'https://www.creativthemes.com/mavix-pro/',
    ),
    'spa-pro' => array(
        'title'          => __( 'Spa Pro', 'creativ-demo-importer' ), 
        'is_pro'         => true,
        'type'           => 'elementor',
        'author'         => __( 'Creativ Themes', 'creativ-demo-importer' ),
        'keywords'       => array( 'mavix', 'spa' ),
        'categories'     => array( 'spa' ),
        'template_url'   => array(
            'content' => CREATIV_DEMO_IMPORTER_URL. 'includes/starter-sites/json/mavix-spa-pro/content.json',
            'options' => CREATIV_DEMO_IMPORTER_URL. 'includes/starter-sites/json/mavix-spa-pro/options.json',
            'widgets' => CREATIV_DEMO_IMPORTER_URL. 'includes/starter-sites/json/mavix-spa-pro/widgets.json',
        ),
        'screenshot_url' => CREATIV_DEMO_IMPORTER_URL.'assets/img/mavix-spa-pro.jpg',
        'demo_url'       => 'https://creativthemes.com/theme-demo/mavix-spa-pro/',
        'pro_url'        => 'https://www.creativthemes.com/mavix-pro/',
    ),
    'beat-pro' => array(
